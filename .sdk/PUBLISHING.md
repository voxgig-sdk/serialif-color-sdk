...
|---|---|---|
| `ts/` | @voxgig-sdk/serialif-color-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/serialif-color-sdk \
      --repository voxgig-sdk/serialif-color-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/serialif-color-sdk` shows it, and
`npm trust revoke @voxgig-sdk/serialif-color-sdk --id=<id>` removes it.
