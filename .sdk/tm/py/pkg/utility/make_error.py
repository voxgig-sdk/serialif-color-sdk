...
def make_error_util(ctx, err):
    if ctx is None:
        from projectname_sdk.core.context import SerialifColorContext
        ctx = SerialifColorContext({}, None)
    ...
    errmsg = ""
    if isinstance(err, SerialifColorError):
        errmsg = err.msg
    ...
    sdk_err = SerialifColorError("", msg, ctx)
