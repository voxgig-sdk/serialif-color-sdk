...
// SerialifColor SDK utility: param

require_once __DIR__ . '/../core/Helpers.php';

class SerialifColorParam
{
    public static function call(SerialifColorContext $ctx, mixed $paramdef): mixed
    {
        $point = $ctx->point;
        $spec = $ctx->spec;
        $match_val = $ctx->match;
        ...
        $akey = '';
        if ($point) {
            $alias_map = SerialifColorHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'alias'));
            if ($alias_map) {
