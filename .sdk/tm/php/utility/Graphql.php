...
// SerialifColor SDK utility: graphql
//
...
class SerialifColorGraphql
{
    ...
    // equivalent.
    public static function body(SerialifColorContext $ctx): mixed
    {
    ...
    public static function errors(SerialifColorContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
