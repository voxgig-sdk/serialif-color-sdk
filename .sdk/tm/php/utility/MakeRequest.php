...
// SerialifColor SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class SerialifColorMakeRequest
{
    public static function call(SerialifColorContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new SerialifColorResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new SerialifColorResponse($fetched);
        } else {
