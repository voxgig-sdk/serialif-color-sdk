...
// SerialifColor SDK timeout feature
...
class SerialifColorTimeoutFeature extends SerialifColorBaseFeature
{
    ...
    private function _with_timeout(SerialifColorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(SerialifColorContext $_ctx, float $ms): void
    {
        $client = $this->client;
