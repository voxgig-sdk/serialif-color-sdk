...
// SerialifColor SDK ratelimit feature
...
class SerialifColorRatelimitFeature extends SerialifColorBaseFeature
{
    ...
    private function _acquire(SerialifColorContext $ctx): void
    {
    ...
    private function _track(SerialifColorContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
