...
// SerialifColor SDK rbac feature
...
class SerialifColorRbacFeature extends SerialifColorBaseFeature
{
    ...
    private function _required(SerialifColorContext $ctx): ?string
    {
    ...
    private function _reject(SerialifColorContext $ctx, string $required): void
    {
    ...
    private function _track(SerialifColorContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
