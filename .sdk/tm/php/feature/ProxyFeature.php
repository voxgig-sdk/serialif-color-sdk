...
// SerialifColor SDK proxy feature
...
class SerialifColorProxyFeature extends SerialifColorBaseFeature
{
    ...
    public function init(SerialifColorContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (SerialifColorContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
