...
// SerialifColor SDK pipeline test
//
...
{
    private static function utility(): SerialifColorUtility
    {
        return new SerialifColorUtility();
    }
    ...
    private static function ctx(array $over = []): SerialifColorContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new SerialifColorContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new SerialifColorOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof SerialifColorError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new SerialifColorOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = SerialifColorMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new SerialifColorOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = SerialifColorMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new SerialifColorOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = SerialifColorMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new SerialifColorSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = SerialifColorMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new SerialifColorResponse([]),
            'result' => new SerialifColorResult([]),
        ]);
        [, $err] = SerialifColorMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new SerialifColorSpec([]),
            'response' => null,
            'result' => new SerialifColorResult([]),
        ]);
        [, $err] = SerialifColorMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new SerialifColorSpec(['step' => 's']),
            'response' => new SerialifColorResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new SerialifColorResult([]),
        ]);
        [, $err] = SerialifColorMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new SerialifColorSpec(['step' => 's']),
            'response' => new SerialifColorResponse(self::resp(200, ['v' => 1])),
            'result' => new SerialifColorResult([]),
        ]);
        [, $err] = SerialifColorMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new SerialifColorSpec(['step' => 's']),
            'response' => new SerialifColorResponse(self::resp(200, ['v' => 2])),
            'result' => new SerialifColorResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        SerialifColorMakeResponse::call($ctx);
    ...
    {
        $preset = new SerialifColorResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new SerialifColorSpec([]),
            'response' => new SerialifColorResponse([]),
            'result' => new SerialifColorResult([]),
        ...
        [$got, $err] = SerialifColorMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new SerialifColorResult([])]);
        [, $err] = SerialifColorMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new SerialifColorSpec([]), 'result' => null]);
        [, $err] = SerialifColorMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new SerialifColorSpec(['step' => 's']),
            'result' => new SerialifColorResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new SerialifColorOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = SerialifColorMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new SerialifColorSpec(['step' => 's']),
            'result' => new SerialifColorResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new SerialifColorOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = SerialifColorMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new SerialifColorResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new SerialifColorSpec([]),
            'result' => new SerialifColorResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = SerialifColorMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = SerialifColorMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new SerialifColorError('boom', 'boom');
        $utility->fetcher = function (SerialifColorContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new SerialifColorSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = SerialifColorMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (SerialifColorContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = SerialifColorMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(SerialifColorResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        SerialifColorMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (SerialifColorContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new SerialifColorSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = SerialifColorMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new SerialifColorResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new SerialifColorSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = SerialifColorMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = SerialifColorMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = SerialifColorMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new SerialifColorResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, SerialifColorDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new SerialifColorResult(['ok' => false])]);
        $this->expectException(SerialifColorError::class);
        SerialifColorDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new SerialifColorResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', SerialifColorMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        SerialifColorMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new SerialifColorBaseFeature();
        $b = new SerialifColorBaseFeature();
        SerialifColorFeatureAdd::call($ctx, $a);
        SerialifColorFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): SerialifColorBaseFeature
    {
        $f = new SerialifColorBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        SerialifColorFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): SerialifColorContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new SerialifColorSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = SerialifColorPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        SerialifColorPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new SerialifColorResponse(['headers' => null]),
            'result' => new SerialifColorResult([]),
        ]);
        SerialifColorResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        SerialifColorResultBody::call($ctx);
