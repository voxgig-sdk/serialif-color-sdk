...
## Install
```bash
go get github.com/voxgig-sdk/serialif-color-sdk/go@latest
```

The Go module proxy resolves the version from the `go/vX.Y.Z` GitHub
release tag — see [Releases](https://github.com/voxgig-sdk/serialif-color-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/serialif-color-sdk/go=../serialif-color-sdk/go
```
...
| `GetColorByPath` | `(data map[string]any) SerialifColorEntity` | Create a GetColorByPath entity instance. |
| `GetColorByQuery` | `(data map[string]any) SerialifColorEntity` | Create a GetColorByQuery entity instance. |

### Entity interface (SerialifColorEntity)

All entities implement the `SerialifColorEntity` interface.
