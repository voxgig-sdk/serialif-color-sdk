...
const testSeed = `map[string]any{"entity": map[string]any{"get_color_by_path": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "get_color_by_query": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
