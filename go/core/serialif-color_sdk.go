...
func (sdk *SerialifColorSDK) OptionsMap() map[string]any {
...
func (sdk *SerialifColorSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *SerialifColorSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *SerialifColorSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *SerialifColorSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *SerialifColorSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *SerialifColorSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("SerialifColorSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *SerialifColorSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *SerialifColorSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("SerialifColorSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *SerialifColorSDK {
	if sdkopts == nil {
	...
	sdk := NewSerialifColorSDK(sdkopts)
	sdk.Mode = "test"
