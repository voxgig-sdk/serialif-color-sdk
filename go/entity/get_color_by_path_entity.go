...
type GetColorByPathEntity struct {
	name    string
...
func NewGetColorByPathEntity(client *core.SerialifColorSDK, entopts map[string]any) *GetColorByPathEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetColorByPathEntity) GetName() string { return e.name }
...
func (e *GetColorByPathEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetColorByPathEntity) Deleted() bool {
	return e.deleted
}


func (e *GetColorByPathEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetColorByPathEntity(e.client, opts)
}

func (e *GetColorByPathEntity) Data(args ...any) any {
...
func (e *GetColorByPathEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GetColorByPath; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetColorByPathEntity) DataTyped(data ...GetColorByPath) GetColorByPath {
	if len(data) > 0 {
		return typedFrom[GetColorByPath](e.Data(asMap(data[0])))
	}
	return typedFrom[GetColorByPath](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GetColorByPath (all fields
// optional at the wire level).
func (e *GetColorByPathEntity) MatchTyped(match ...GetColorByPath) GetColorByPath {
	if len(match) > 0 {
		return typedFrom[GetColorByPath](e.Match(asMap(match[0])))
	}
	return typedFrom[GetColorByPath](e.Match())
}
...
func (e *GetColorByPathEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetColorByPathEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GetColorByPathLoadMatch and returns an GetColorByPath. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GetColorByPathEntity) LoadTyped(reqmatch GetColorByPathLoadMatch, ctrl map[string]any) (GetColorByPath, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GetColorByPath{}, err
	}
	return typedFrom[GetColorByPath](res), nil
}



func (e *GetColorByPathEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GetColorByPathEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetColorByPathEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetColorByPathEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetColorByPathEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
