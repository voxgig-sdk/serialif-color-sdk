...
describe("GetColorByQueryDirect", function()
  it("should direct-load-get_color_by_query", function()
    local setup = get_color_by_query_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-get_color_by_query", setup.live and "live" or "unit")
...
function get_color_by_query_direct_setup(mockres)
