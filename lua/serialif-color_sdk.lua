...
local SerialifColorSDK = {}
SerialifColorSDK.__index = SerialifColorSDK
...
SerialifColorSDK._make_feature = _make_feature


function SerialifColorSDK.new(options)
  local self = setmetatable({}, SerialifColorSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function SerialifColorSDK:options_map()
...
function SerialifColorSDK:get_utility()
  return Utility.copy(self._utility)
end


function SerialifColorSDK:get_root_ctx()
  return self._rootctx
end


function SerialifColorSDK:prepare(fetchargs)
...
function SerialifColorSDK:direct(fetchargs)
...
-- by passing it.
function SerialifColorSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function SerialifColorSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "SerialifColorSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function SerialifColorSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = SerialifColorSDK.new(sdkopts)
  sdk.mode = "test"
