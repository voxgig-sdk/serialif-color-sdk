...
local GetColorByPathEntity = {}
GetColorByPathEntity.__index = GetColorByPathEntity


function GetColorByPathEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetColorByPathEntity)
  self._name = "get_color_by_path"
  self._client = client
...
function GetColorByPathEntity:get_name()
  return self._name
end


function GetColorByPathEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetColorByPathEntity.new(self._client, opts)
end
...
function GetColorByPathEntity:mark_deleted()
  self._deleted = true
end


function GetColorByPathEntity:deleted()
  return true == self._deleted
end


function GetColorByPathEntity:data_set(args)
  if args ~= nil then
...
function GetColorByPathEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetColorByPathEntity:match_set(args)
  if args ~= nil then
...
function GetColorByPathEntity:match_get()
...
function GetColorByPathEntity:stream(action, args, callopts)
...
function GetColorByPathEntity:_run_op(ctx, post_done)
  local utility = self._utility
