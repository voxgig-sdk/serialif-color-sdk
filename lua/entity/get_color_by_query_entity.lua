...
local GetColorByQueryEntity = {}
GetColorByQueryEntity.__index = GetColorByQueryEntity


function GetColorByQueryEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetColorByQueryEntity)
  self._name = "get_color_by_query"
  self._client = client
...
function GetColorByQueryEntity:get_name()
  return self._name
end


function GetColorByQueryEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetColorByQueryEntity.new(self._client, opts)
end
...
function GetColorByQueryEntity:mark_deleted()
  self._deleted = true
end


function GetColorByQueryEntity:deleted()
  return true == self._deleted
end


function GetColorByQueryEntity:data_set(args)
  if args ~= nil then
...
function GetColorByQueryEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetColorByQueryEntity:match_set(args)
  if args ~= nil then
...
function GetColorByQueryEntity:match_get()
...
function GetColorByQueryEntity:stream(action, args, callopts)
...
function GetColorByQueryEntity:_run_op(ctx, post_done)
  local utility = self._utility
