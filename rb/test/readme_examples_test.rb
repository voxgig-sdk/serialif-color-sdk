...
#      offline in seeded test mode (SerialifColorSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "SerialifColor_sdk.rb")
  SDK_CLASS = "SerialifColorSDK"
