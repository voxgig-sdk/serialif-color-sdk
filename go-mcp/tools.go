...
type Args struct {
	Entity string         `json:"entity" jsonschema:"get_color_by_path | get_color_by_query"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.SerialifColorSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "serialif-color_list",
		Description: "List records from SerialifColor. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "serialif-color_load",
		Description: "Load a single record from SerialifColor. " +
...
func runOp(client *sdk.SerialifColorSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.SerialifColorSDK, name string) (sdk.SerialifColorEntity, error) {
	switch strings.ToLower(name) {
	case "get_color_by_path":
		return client.GetColorByPath(nil), nil
	case "get_color_by_query":
		return client.GetColorByQuery(nil), nil
