// Command SerialifColor-mcp is an MCP server exposing the SerialifColor
// SDK as MCP tools.
//
// Two tools are registered:
//
//	SerialifColor_list  — list records of an entity
//	SerialifColor_load  — load a single record of an entity
//
