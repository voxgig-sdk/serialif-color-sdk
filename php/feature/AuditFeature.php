...
// SerialifColor SDK audit feature
...
class SerialifColorAuditFeature extends SerialifColorBaseFeature
{
    ...
    private function _emit(SerialifColorContext $ctx, string $outcome): void
    {
