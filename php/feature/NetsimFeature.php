...
// SerialifColor SDK netsim feature
...
class SerialifColorNetsimFeature extends SerialifColorBaseFeature
{
    ...
    private function _simulate(SerialifColorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(SerialifColorContext $ctx, array $applied): void
    {
        $client = $this->client;
