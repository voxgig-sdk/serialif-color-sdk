...
// SerialifColor SDK debug feature
...
class SerialifColorDebugFeature extends SerialifColorBaseFeature
{
    ...
    private function _finish(SerialifColorContext $ctx, bool $ok): void
    {
