...
// SerialifColor SDK cache feature
...
class SerialifColorCacheFeature extends SerialifColorBaseFeature
{
    ...
    private function _through(SerialifColorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
