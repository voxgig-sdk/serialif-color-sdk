...
// SerialifColor SDK clienttrack feature
...
class SerialifColorClienttrackFeature extends SerialifColorBaseFeature
{
    ...
    public function PostConstruct(SerialifColorContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'SerialifColor-SDK';
