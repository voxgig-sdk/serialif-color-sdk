# SerialifColor PHP SDK

The PHP SDK for the SerialifColor API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->GetColorByPath(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->SerialifColor(null)->load(
    ["id" => "test01"], null
);
...
```
php/
├── serialifcolor_sdk.php          -- Main SDK class
...
The main class (`serialifcolor_sdk.php`) exports the SDK class
