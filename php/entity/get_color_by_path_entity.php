...
// SerialifColor SDK GetColorByPath entity
...
class GetColorByPathEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GetColorByPathEntity($this->_client, $opts);
    }

    /**
     * @param GetColorByPath|array $args GetColorByPath data (assoc-array) to store.
     */
    ...
    /**
     * @return GetColorByPath|array The current GetColorByPath data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GetColorByPath fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GetColorByPath fields).
     */
    ...
    /**
     * Load a single GetColorByPath.
     *
     * @param GetColorByPathLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GetColorByPathLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GetColorByPath|array The loaded GetColorByPath as an assoc-array at the
