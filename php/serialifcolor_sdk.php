...
class SerialifColorSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = SerialifColorHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = SerialifColorHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!SerialifColorFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, SerialifColorFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return SerialifColorUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = SerialifColorHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = SerialifColorHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = SerialifColorHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new SerialifColorError($op . "_allow",
                "SerialifColorSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = SerialifColorHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new SerialifColorError("graphql_error",
                "SerialifColorSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function GetColorByPath($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_get_color_by_path === null) {
                $this->_get_color_by_path = new GetColorByPathEntity($this, null);
            }
            return $this->_get_color_by_path;
        }
        return new GetColorByPathEntity($this, $data);
    }
    ...
    public function GetColorByQuery($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_get_color_by_query === null) {
                $this->_get_color_by_query = new GetColorByQueryEntity($this, null);
            }
            return $this->_get_color_by_query;
        }
        return new GetColorByQueryEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new SerialifColorSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
