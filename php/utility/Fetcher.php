...
// SerialifColor SDK utility: fetcher

class SerialifColorFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; SerialifColorSDK/1.0)';
    ...
    public static function call(SerialifColorContext $ctx, string $fullurl, array $fetchdef): array
    {
