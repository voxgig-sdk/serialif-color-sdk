...
// SerialifColor SDK utility: make_options

class SerialifColorMakeOptions
{
    ...
    public static function call(SerialifColorContext $ctx): array
    {
        ...
        //
        // `SerialifColorSchema::optspec()` is built from the model:
        ...
        $optspec = SerialifColorSchema::optspec();
