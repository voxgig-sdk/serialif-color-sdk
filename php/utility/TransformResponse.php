...
// SerialifColor SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class SerialifColorTransformResponse
{
    public static function call(SerialifColorContext $ctx): mixed
    {
        ...
        $transform = SerialifColorHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
