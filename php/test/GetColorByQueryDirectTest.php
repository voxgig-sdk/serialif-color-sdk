...
class GetColorByQueryDirectTest extends TestCase
{
    public function test_direct_load_get_color_by_query(): void
    {
        $setup = get_color_by_query_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-get_color_by_query", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
