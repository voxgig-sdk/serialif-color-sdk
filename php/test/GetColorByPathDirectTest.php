...
class GetColorByPathDirectTest extends TestCase
{
    public function test_direct_load_get_color_by_path(): void
    {
        $setup = get_color_by_path_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-get_color_by_path", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
