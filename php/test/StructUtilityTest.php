...
// SerialifColor SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = SerialifColorOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(SerialifColorOmni::structfix($now, Struct::undef()))
                        !== json_encode(SerialifColorOmni::structfix($val, Struct::undef()))) {
