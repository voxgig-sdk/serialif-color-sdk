...
// SerialifColor SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (SerialifColorSDK::test)
...
{
    private const SDK_CLASS = 'SerialifColorSDK';
    ...
    private const SDK_BASE = 'serialifcolor_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../serialifcolor_sdk.php';
