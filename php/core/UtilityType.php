...
// SerialifColor SDK utility type

class SerialifColorUtility
{
    ...
    public static function copy(SerialifColorUtility $src): SerialifColorUtility
    {
        $u = new SerialifColorUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
