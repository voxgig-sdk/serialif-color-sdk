...
AQL-driven CLI and REPL for the SerialifColor SDK. Positional arguments are
...
./serialif-color-cli list get_color_by_path
./serialif-color-cli load 1 get_color_by_path
./serialif-color-cli load '{id:1}' get_color_by_path
