...
func registerSDKWords(r *eng.Registry, client *sdk.SerialifColorSDK) {
...
func runOp(client *sdk.SerialifColorSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
