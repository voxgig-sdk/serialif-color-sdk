...
(0, node_test_1.describe)('GetColorByQueryDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-get_color_by_query', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-get_color_by_query', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['SERIALIF_COLOR_TEST_GET_COLOR_BY_QUERY_ENTID'];
...
//# sourceMappingURL=GetColorByQueryDirect.test.js.map