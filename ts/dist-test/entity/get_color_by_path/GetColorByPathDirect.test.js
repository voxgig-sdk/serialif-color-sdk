...
(0, node_test_1.describe)('GetColorByPathDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.SerialifColorSDK({
    ...
    (0, node_test_1.test)('direct-load-get_color_by_path', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-get_color_by_path', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.SERIALIF_COLOR_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.SerialifColorSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['SERIALIF_COLOR_TEST_GET_COLOR_BY_PATH_ENTID'];
    ...
    const client = new __1.SerialifColorSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GetColorByPathDirect.test.js.map