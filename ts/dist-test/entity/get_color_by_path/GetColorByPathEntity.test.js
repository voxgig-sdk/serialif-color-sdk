...
(0, node_test_1.describe)('GetColorByPathEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'get_color_by_path.' + op, live))
                return;
        }
        ...
        let get_color_by_path_ref01_data = Object.values(setup.data.existing.get_color_by_path)[0];
        // LOAD
        const get_color_by_path_ref01_ent = client.GetColorByPath();
        const get_color_by_path_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(get_color_by_path_ref01_data_dt0.id === get_color_by_path_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/get_color_by_path/GetColorByPathTestData.json');
    ...
    let idmap = transform(['get_color_by_path01', 'get_color_by_path02', 'get_color_by_path03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=GetColorByPathEntity.test.js.map