...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/serialif-color` | `npm install @voxgig-sdk/serialif-color` |
| Python | `voxgig-sdk-serialif-color` | `pip install voxgig-sdk-serialif-color` |
| PHP | `voxgig-sdk/serialif-color` | `composer require voxgig-sdk/serialif-color` |
| Golang | `github.com/voxgig-sdk/serialif-color-sdk/go` | `go get github.com/voxgig-sdk/serialif-color-sdk/go` |
| Ruby | `voxgig-sdk-serialif-color` | `gem install voxgig-sdk-serialif-color` |
| Lua | `voxgig-sdk-serialif-color` | `luarocks install voxgig-sdk-serialif-color` |
