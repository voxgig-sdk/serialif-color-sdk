# SerialifColor Python SDK



The Python SDK for the SerialifColor API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.GetColorByPath()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/serialif-color-sdk/releases)) or
...
```python
client = SerialifColorSDK.test(testopts, sdkopts)
```
...
| --- | --- | --- |
| `base` | `dict` | Requested base color |
| `base_without_alpha` | `dict` | Base color without alpha channel |
| `base_without_alpha_contrasted_text` | `dict` | Black or white text color that contrasts with base color |
| `complementary` | `dict` | Complementary color |
| `complementary_without_alpha` | `dict` | Complementary color without alpha channel |
| `complementary_without_alpha_contrasted_text` | `dict` | Black or white text color that contrasts with complementary color |
...
```
py/
├── serialifcolor_sdk.py         -- Main SDK module
...
The main module (`serialifcolor_sdk`) exports the SDK class.
