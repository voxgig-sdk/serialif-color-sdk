...
class SerialifColorTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = SerialifColorTestRunner.getenv("SERIALIFCOLOR_TEST_LIVE")
        override = SerialifColorTestRunner.getenv("SERIALIFCOLOR_TEST_OVERRIDE")
        ...
        explain = SerialifColorTestRunner.getenv("SERIALIFCOLOR_TEST_EXPLAIN")
