# SerialifColor SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions SerialifColorSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both SerialifColorSDK(...) and SerialifColorSDK.test(...) become
#      SerialifColorSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "serialifcolor_sdk"
_SDK_CLASS = "SerialifColorSDK"
...
_ENTITIES = {
    "GetColorByPath": "get_color_by_path",
    "GetColorByQuery": "get_color_by_query",
}
