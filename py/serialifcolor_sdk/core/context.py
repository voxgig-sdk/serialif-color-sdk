...
from serialifcolor_sdk.core.helpers import get_ctx_prop, to_map
...
class SerialifColorContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = SerialifColorControl()
        ...
        if isinstance(sp, SerialifColorSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, SerialifColorResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, SerialifColorResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return SerialifColorError(code, msg, self)
