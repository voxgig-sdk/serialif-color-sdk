...
from serialifcolor_sdk.serialifcolor_types import (
    GetColorByPath,
...
class GetColorByPathEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetColorByPathEntity(self._client, opts)
    ...
    def data_get(self) -> GetColorByPath:
    ...
    def match_get(self) -> GetColorByPath:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GetColorByPath:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GetColorByPath().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
