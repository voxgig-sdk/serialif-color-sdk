...
from serialifcolor_sdk.utility import register

# Load features
from serialifcolor_sdk.feature.base_feature import SerialifColorBaseFeature
from serialifcolor_sdk.features import _has_feature, _make_feature
...
class SerialifColorSDK:
    ...
    def get_utility(self):
        return SerialifColorUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("SerialifColorSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def GetColorByPath(self, data=None) -> "GetColorByPathEntity":
        ...
        from serialifcolor_sdk.entity.get_color_by_path_entity import GetColorByPathEntity
    ...
    def GetColorByQuery(self, data=None) -> "GetColorByQueryEntity":
        ...
        from serialifcolor_sdk.entity.get_color_by_query_entity import GetColorByQueryEntity
